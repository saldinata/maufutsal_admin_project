                    ...
                    <table id="datatable" class="table table-striped table-colored table-info">
                        <thead>
                            <tr>
                                ...
                                <th style="background-color: #656664;font-size: 13px;text-align: center;font-size: 11px;">User Kepemilikan</th>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            ...
                            {
                                $date_join = $util->changeFormatDateFromNumberToString(substr($data_info['court_reg'],
                                                0, 8));

                                $id_prov = $data_info['id_prov'];
                                $id_city = $data_info['id_kota'];
                                $id_user = $data_info['id_user'];

                                $query       = "SELECT * FROM tbl_user WHERE id_user=?";
                                $result_user = $db->getValue($query, [$id_user]);
                                ...
                                echo "<td class=\"text-center\" style=\"font-size: 11px;\">" . $result_user['username'] . "</td>";
                                echo "</tr>";
                            }
                            ?>
                        </tbody>
