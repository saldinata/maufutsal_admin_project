    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="page-title-box">
            <h4 class="page-title">Karir Maufutsal</h4>
...
<script type="text/javascript">
  ...
  function saveContent()
  {
    ...
    ({
        ...
        url       : url,
        dataType  : "JSON",
        data      : "type=reqsavecareercontent"+"&contents="+contents,
        cache     : false,
        success   : function(JSONObject)
        {
          for(var key in JSONObject)
          {
            ...
            {
              if((JSONObject[key]["type"])==="ressavecareercontent")
              {
