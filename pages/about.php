    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="page-title-box">
            <h4 class="page-title">Tentang Maufutsal</h4>
...
<script type="text/javascript">
  ...
  function saveContent()
  {
    ...
    ({
        ...
        url       : url,
        dataType  : "JSON",
        data      : "type=reqsaveaboutcontent"+"&contents="+contents,
        cache     : false,
        success   : function(JSONObject)
        {
          for(var key in JSONObject)
          {
            ...
            {
              if((JSONObject[key]["type"])==="ressaveaboutcontent")
              {
